# -*- coding: utf-8 -*-
"""
Created on Fri Apr 25 10:48:57 2025
...
lidar_path = r"D:\NASA_EPSCoR_Snow\Band_7_Sensor\Data\Processing_2025_0425\Data\Lidar\20250305_Namaste_YS_dsm.tif"  # EPSG:4326
...
gdf_pixels.plot(ax=lidar_plot, facecolor='none', edgecolor='red', linewidth=3, label='≥50% Overlap Grid')
...
gdf_lidar_cropped = gpd.overlay(gdf_lidar, gdf_pixels, how='intersection')
...
lidar_plot = gdf_lidar_cropped.plot(
    column='value_1',
    cmap=cmap,
    norm=norm,
    legend=False,
